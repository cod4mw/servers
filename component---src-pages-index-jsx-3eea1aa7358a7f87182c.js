...
/***/ (function(module, exports, __webpack_require__) {
	...
	var settle = __webpack_require__(205);
	...
	var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(207);
...
/***/ (function(module, exports) {
	...
	module.exports = [{"address":"139.59.57.83:28960"}]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gatsbyLink = __webpack_require__(327);
	...
	var _servers = __webpack_require__(343);
	...
	var IndexPage = function (_React$Component) {
	  ...
	  IndexPage.prototype.componentDidMount = function () {
	    var _ref = _asyncToGenerator(function* () {
	      var serverInfos = [];
	      for (var _iterator = _servers2.default, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
	        var _ref2;
	        ...
	        var res = yield _axios2.default.get('https://cod4mw-serverinfo-api.glitch.me/' + server.address);
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        this.state.servers.map(function (server, i) {
	          var address = server.host + ':' + server.port;
	
	          return _react2.default.createElement(
	            'a',
	            { href: 'cod4://' + address, className: 'server', key: i },
	            _react2.default.createElement(
	              'div',
	              { className: 'name' },
	              server.data.name
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                server.data.voice ? _react2.default.createElement(
	                  'span',
	                  { title: 'Voice Enabled' },
	                  '\uD83D\uDD09'
	                ) : _react2.default.createElement(
	                ...
	                server.data.protected ? _react2.default.createElement(
	                  'span',
...
//# sourceMappingURL=component---src-pages-index-jsx-3eea1aa7358a7f87182c.js.map